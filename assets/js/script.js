...
(function($){
  $(document).ready(function(){
    ...
    $("table tr td input[type='checkbox']").on('change',function(){
        let all_checked =  $("table tr td input[type='checkbox']:checked");
    ...
    $("#main_menuv2 .menu-toggle").on("click",function(){
    ...
    //    console.log(w);
        if(w < 768){
                $("#main_menuv2 li.menu-item-has-children > a").on("click",function(e){
                    e.preventDefault();
             ...
             $("#primary-menu > li").on("mouseenter",function(){
               ...
               $("#primary-menu > li").on("mouseleave",function(){
                 ...
                 //  let me = this;
                 //  setTimeout(function(){ $(me).addClass('hideme'); },700);
               });
        }
